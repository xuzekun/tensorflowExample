...
PATH_TO_LABELS = 'G:\\myGitCode\\models\\research\\object_detection\\data\\mscoco_label_map.pbtxt'
...
#
# PATH_TO_IAMGE_DIR = 'test_images'
# TEST_IMAGE_PATHS = [os.path.join(PATH_TO_IAMGE_DIR, 'image{}.jpg'.format(i)) for i in range(1,3)]
#
# IMAGE_SIZE = (12,8)
